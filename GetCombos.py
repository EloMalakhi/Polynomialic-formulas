...
if Test == True:
    ...
    for i in range(40000*5):
        ...
        M1 = Decimal(72*a*c*e - 27*a*d*d - 27*b*b*e + 9*b*c*d - 2*c*c*c)
        M2 = Decimal(12*a*e - 3*b*d + c*c)
        x_first_real, x_first_imag = calculate_solution(a,b,c,d,e,switch=1)
        x_second_real, x_second_imag = calculate_solution(a,b,c,d,e,switch=2)
        x_first_opt_real, x_first_opt_imag = func(a,b,c,d,e,x_first_real, x_first_imag)
        x_second_opt_real, x_second_opt_imag = func(a,b,c,d,e,x_second_real, x_second_imag)
...
# if ADD - 4ACE + BEB = 0 then
# P5 = √(-4AE)
# else
# P5 = (c - M3)√(1 - 4AE/(c - M3)^2)